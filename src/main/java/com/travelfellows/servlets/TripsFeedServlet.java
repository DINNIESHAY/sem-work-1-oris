...
@WebServlet("/trips-feed")
public class TripsFeedServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            List<TripWithOwner> trips;

            if (userId != null) {
                trips = tripService.findAllTripsWithFavorites(userId);
            } else {
                trips = tripService.findAllTripsWithOwner();
            }
